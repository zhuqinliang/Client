...
namespace Client
{
    public partial class FreeOrder : Form
    {
        private string freeConsumptionsid;
        private HttpAskfor httpReq = new HttpAskfor();
        public FreeOrder(string consumptionsid)
        {
            InitializeComponent();
            freeConsumptionsid = consumptionsid;
        }
        ...
        public void Form_Esc()
        {
            ...
            mb.Btn_Free.Image = Properties.Resources.免单;
